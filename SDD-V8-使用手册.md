...
- **优先官方订阅**：[ChatGPT Pro 官方购买页](https://chatgpt.com/explore/pro?utm_internal_source=openai_developers_codex)。
- **内部采购咨询**：可扫描下方二维码联系 AI chat（浙江杭州）；该联系人为第三方渠道，**非 OpenAI 官方**。
- **账号归属**：一人一号，尽量绑定购买人或公司可控邮箱；交付后立即修改密码并开启 MFA，禁止多人共享账号。
- **采购确认**：下单前确认 5×/20× 档位、账号找回方式、续费、售后、退款和票据，并按公司内部采购与安全流程审批。

> **额度说明**：5× 是相对 Plus 的使用上限档位，不代表固定任务数或固定 Token。实际价格、可用模型和限额以购买时的 [OpenAI Codex Pricing](https://learn.chatgpt.com/docs/pricing) 页面为准。

![内部 Codex 采购咨询联系人 AI chat 的微信二维码](assets/codex/purchase-channel-ai-chat.jpg)
